...
class NeighbourTestClass(TestCase):
    ...
    def setUp(self):
        self.Nei= Neighbour(name = 'Jeff', location='Kenya')
    ...
    def test_get_hood_by_id(self):
        ...
        self.assertTrue(hoods.name,'kenha')
...
# Testing  instance
    ...
    def test_edit_profile(self):
        ...
        self.update_profile = Profile.objects.filter(bio='MIMI').update(bio = 'YOH')
        self.updated_profile = Profile.objects.get(bio='YOH')
        self.assertTrue(self.updated_profile.bio,'YOH')

class PostTestClass(TestCase):

    def setUp(self):
        self.Pos= Post(post='Made with love')
...
class BusinessTestClass(TestCase):
    ...
    def setUp(self):
        self.Bus= Business(name = 'Eggie', description='best ever')
    ...
    def test_data(self):
        self.assertTrue(self.Bus.name,"Eggie")
    ...
    def test_get_biz_by_id(self):
        ...
        self.assertTrue(bizs.name,'kenha')
